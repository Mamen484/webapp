...
describe('SflLegacyLinkService', () => {
    ...
    it('should not set params from prototype', () => {
        authService.getAuthToken.and.returnValue('xsw');
        const Params = function () {
            this.ownProperty = 'ownProperty'
        };
        Params.prototype.parentProperty = 'parentProperty';
        expect(service.getLegacyLink('/some/path', new Params(), false)).toEqual('legacyLink/some/path?ownProperty=ownProperty');
    });
});
