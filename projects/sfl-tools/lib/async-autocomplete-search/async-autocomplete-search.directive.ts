...
import { SftSearchService } from './search.service';
 ...
 *        sftAsyncAutocompleteSearch (searchResults)="searchResults = $event" (processingSearch)="processing = $event">
 ...
 */
@Directive({
    selector: '[sftAsyncAutocompleteSearch]',
})
export class SftAsyncAutocompleteSearchDirective implements OnInit {
    ...
    constructor(protected searchService: SftSearchService<any>) {
    }
