...
@NgModule({
    declarations: [TrackingToolsComponent, EnableGoogleAnalyticsDirective, EnableZendeskChatDirective, EnableAutopilotDirective, EnableAppcuesDirective, EnableFullstoryDirective, EnableSalesMachineDirective, EnableFacebookDirective],
    imports: [
        CommonModule,
...
export class TrackingToolsModule {
    static forRoot(dependency: { GA_MEASUREMENT_ID, ZENDESK_ACCOUNT_LINK, DEFAULT_AUTOPILOT_EMAIL, DEFAULT_AUTOPILOT_STORENAME, FULLSTORY_ORG_ID }): ModuleWithProviders<TrackingToolsModule> {
        return {
